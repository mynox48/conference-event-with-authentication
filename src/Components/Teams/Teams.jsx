...
import Teams1 from "..//..//assets/teams (1).jpg";
import Teams2 from "..//..//assets/teams (2).jpg";
import Teams3 from "..//..//assets/teams (3).jpg";
    ...
    <div className="w-11/12 mx-auto my-15">
      <section className="py-6 rounded-xl bg-gray-100 text-gray-800">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          ...
          <h1 className="text-3xl font-bold leading-none text-center sm:text-5xl mb-15 text-[#00a4ef]">
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-800 text-gray-100">
              ...
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leading-snug">Mr. Rased</p>
                <p>Project Manager</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                <a
                  ...
                  target="_blank"
                  title="Email"
                  className="text-gray-50 hover:text-default-600"
                >
                  <svg
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-gray-800 text-gray-100">
              <img
                alt=""
                className="object-cover self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500"
                src={Teams3}
              />
              <div className="flex-1 my-4">

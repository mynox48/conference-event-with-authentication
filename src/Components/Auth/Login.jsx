...
const Login = () => {
	...
	<form noValidate="" action="" className="space-y-8">
		...
		<button type="button" className="bg-[#00a4ef] text-white hover:bg-base-300 hover:text-black hover:border-0 cursor-pointer w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50">Sign in</button>
	</form>
</div>
        </div>
    );

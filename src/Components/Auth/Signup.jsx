...
<h2 className="mb-3 text-3xl font-semibold text-center">Signup for new account</h2>
<p className="text-sm text-center dark:text-gray-600">Already have an account?
    <Link to='/login' href="#" rel="noopener noreferrer" className="text-blue-600 underline focus:underline hover:underline">Sign in here</Link>
</p>
...
<form onSubmit={handleSignUp} noValidate="" action="" className="space-y-8">
    <div className="space-y-4">
        <div className="space-y-2">
            ...
            <input type="text" name="name" id="name" placeholder="Andrew John" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
            ...
            <input type="text" name="photourl" id="photourl" placeholder="https://photourl.com" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
        </div>
        ...
        <div className="space-y-2">
         ...
         <button onClick={() => setShowPassword(!showPassword)} className='btn btn-sm absolute top-1 right-2'> {showPassword ? <FaEyeSlash></FaEyeSlash> : <FaEye></FaEye>}
         </button>
         </div>
        </div>
    </div>
    <button  type="submit" className="bg-[#00a4ef] text-white hover:bg-base-300 hover:text-black hover:border-0 cursor-pointer w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50">Sign in</button>
</form>
</div>
<ToastContainer />
    </div>
